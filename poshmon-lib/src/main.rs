...
use poshmon_lib::engine::{gen1::{PermStatus, VolatileStatus}, generics::SpriteData};

fn main() {
    use poshmon_lib::engine::gen1::{BasePokemon, Pokemon, PokeType, MoveType, PokeMove, StatXP};
