...
impl Packet {
    ...
    pub fn new(session_token: SessionToken, data: Box<dyn Communication>) -> Self {
...
impl serde::ser::Serialize for Packet {
        ...
        S: Serializer,
    {
        ...
        s.serialize_entry("body", &self.data.to_json_str())?;
...
impl serde::ser::Serialize for OutPacket {
        ...
        S: Serializer,
    {
        ...
        println!("{}.{}", &msg, b64bytes);
        let mut s = serializer.serialize_map(None)?;
        s.serialize_entry("token", &msg)?;
