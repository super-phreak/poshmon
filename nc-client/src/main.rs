...
fn main() -> io::Result<()>{
    ...
    // viewport.draw_frame(7, 7);
    // stdout.queue(cursor::MoveTo(0,0))?;
    // stdout.flush()?;
    // viewport.set_vbuff(k_vbuff);
    // viewport.draw_frame(7, 7);
