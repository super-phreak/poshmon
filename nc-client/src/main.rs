...
fn main() {
    ...
    let mut viewport = Viewport::new(7, 7, 0, 0, 8, pallets[BulitinPallets::GbClassicColors].clone());
    ...
    // let kangaskhan_back_sprite = Sprite::new(4,4,"".to_owned());
    ...
    let r_vbuff = rhydon_front_sprite.to_vbuff(8, false).unwrap();
    println!("{}", r_vbuff.len());
    viewport.set_vbuff(r_vbuff);
    viewport.draw_canvas();
